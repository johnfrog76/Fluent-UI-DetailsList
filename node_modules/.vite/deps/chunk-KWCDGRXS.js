...
setVersion("@fluentui/merge-styles", "8.5.2");
...
var _syncModuleCache = typeof WeakMap !== "undefined" ? /* @__PURE__ */ new WeakMap() : void 0;
function asAsync(options) {
  var Async2 = function(_super) {
...
setVersion("@fluentui/dom-utilities", "2.2.1");
...
function customizable(scope, fields, concatStyles) {
  return function customizableFactory(ComposedComponent) {
    var _a3;
    var resultClass = (_a3 = function(_super) {
...
function setCallbackMap(key) {
  ...
  var onMouseDown = function(ev) {
    return _onMouseDown2(ev, key);
  };
  var onPointerDown = function(ev) {
    return _onPointerDown2(ev, key);
  };
  var onKeyDown = function(ev) {
    return _onKeyDown2(ev, key);
  };
  var onKeyUp = function(ev) {
    return _onKeyUp(ev, key);
  };
  callbacks = { onMouseDown, onPointerDown, onKeyDown, onKeyUp };
  callbackMap.set(key, callbacks);
  return callbacks;
}
var FocusRectsContext = React9.createContext({});
var FocusRectsProvider = FocusRectsContext.Provider;
function useFocusRects(rootRef) {
  var providerRef = React9.useContext(FocusRectsContext).providerRef;
...
function _onMouseDown2(ev, providerElem) {
  setFocusVisibility(false, ev.target, providerElem);
}
function _onPointerDown2(ev, providerElem) {
  if (ev.pointerType !== "mouse") {
    setFocusVisibility(false, ev.target, providerElem);
  }
}
function _onKeyDown2(ev, providerElem) {
  if (isDirectionalKeyCode(ev.which)) {
    setFocusVisibility(true, ev.target, providerElem);
  }
}
...
function styled(Component6, baseStyles, getProps, customizable2, pure) {
  ...
  var Wrapped = React10.forwardRef(function(props, forwardedRef) {
    ...
    return React10.createElement(Component6, __assign({ ref: forwardedRef }, rest, additionalProps, props, { styles: styles.current }));
  });
...
setVersion("@fluentui/utilities", "8.10.1");
...
setVersion("@fluentui/theme", "2.6.9");
...
var HighContrastSelectorWhite = "@media screen and (-ms-high-contrast: black-on-white), screen and (forced-colors: active) and (prefers-color-scheme: light)";
var HighContrastSelectorBlack = "@media screen and (-ms-high-contrast: white-on-black), screen and (forced-colors: active) and (prefers-color-scheme: dark)";
...
function getEdgeChromiumNoHighContrastAdjustSelector() {
  var _a3;
  return _a3 = {}, _a3[EdgeChromiumHighContrastSelector] = {
    forcedColorAdjust: "none",
    MsHighContrastAdjust: "none"
  }, _a3;
}
...
setVersion("@fluentui/style-utilities", "8.7.4");
...
//# sourceMappingURL=chunk-KWCDGRXS.js.map
