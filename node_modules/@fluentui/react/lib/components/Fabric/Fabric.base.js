...
import { classNamesFunction, divProperties, getDocument, getNativeProps, getRTL, memoizeFunction, Customizer, FocusRectsContext, FocusRectsProvider, } from '../../Utilities';
...
function useRenderedContent(props, _a, rootElement, ref) {
    ...
    var parentProviderRef = React.useContext(FocusRectsContext).providerRef;
    ...
    var renderedContent = (React.createElement(FocusRectsProvider, { value: focusRectsContext },
