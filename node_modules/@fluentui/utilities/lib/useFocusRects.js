...
export var FocusRectsContext = React.createContext({});
export var FocusRectsProvider = FocusRectsContext.Provider;
/**
...
export function useFocusRects(rootRef) {
    var providerRef = React.useContext(FocusRectsContext).providerRef;
